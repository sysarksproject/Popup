                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div>
                                         <a href="updated.html">Create New</a>
...
<div class="row customRow">
        ...
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
            <h3 style="font-size: x-small;font-weight: bold; text-align: left; margin-bottom:2px;">Category</h3>
            <input type="text" id="click" name="click" value="" class="form-control customFormControl" />
                </div>
        </div>
		
    <div class="row customRow">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h3 style="font-size: x-small;font-weight: bold; text-align: left; margin-bottom:2px;">Task</h3>
            <input type="text" id="back" name="back" value="" class="form-control customFormControl" />
        </div>
    </div>   
    <div class="row customRow">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            ...
            <input type="text" id="front" name="front" value="" class="form-control customFormControl"  />
        </div>

        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <h3 style="font-size: x-small;font-weight: bold; text-align: left; margin-bottom:2px;">Hourly Rate</h3>
           
            <input type="text" id="east" name="east" value="" class="form-control customFormControl"/>
        </div>

        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <h3 style="font-size: x-small;font-weight: bold; text-align: left; margin-bottom:2px;">Task Amount</h3>

            <input type="text" id="west" name="west" value="" class="form-control customFormControl" />
        </div>
    </div>  
    ...
    <div class="row customRow">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <textarea id="south" name="south" value="" class="form-control customFormControl" style="height:90px;"></textarea>
        </div>
    </div>
    
    <div class="row customRowFooterControls">
        <div class="col-lg-4 pull-right">
            <button type="button" class="w3-btn w3-green w3-margin-bottom customButton" data-dismiss="modal" id="addto">Confirm</button>
        <script>
$('#addto').click(function() {
    count=$('#table1 tr').length;
      ...
      allo = $('#west').val(),
      allocation = $('#east').val();
$('#table1 tbody').append('<tr><td>' + prom + '</td><td>' + cur + '</td><td>' + price + '</td><td>' + allocation + '</td><td>' + alloc + '</td><td>' + allo + '</td></tr>');
});
    ...
    <div class="row customRow">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <h3 style="font-size: x-small;font-weight: bold; text-align: left; margin-bottom:2px;">Address 1</h3>
            <input type="text" class="form-control customFormControl" />
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
             <h3 style="font-size: x-small;font-weight: bold; text-align: left; margin-bottom:2px;">Address 2</h3>
    ...
    <div class="footer">
        ...
        <div class="row customRow">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <h3 style="font-size: x-small;font-weight: bold; text-align: left; margin-bottom:2px;">Expense No</h3>
               
                <input  type="text" id="west1" name="west1" value="" class="form-control customFormControl"/>
            </div>
        </div>
        <div class="row customRow">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <input type="text" id="click1" name="click1" value=""  class="form-control customFormControl" />
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <h3 style="font-size: x-small;font-weight: bold; text-align: left; margin-bottom:2px;">Expense Amount</h3>
                
                <input type="text" id="south1" name="south1" value=""  class="form-control customFormControl" />
            </div>  
        </div>
        <div class="row customRow">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <input type="text" id="north1" name="north1" value="" class="form-control customFormControl"/>
        </div>
        </div>
    ...
    <div class="row customRowFooterControls">        
        <div class="col-lg-4 pull-right">
            <button type="button" class="w3-btn w3-green w3-margin-bottom customButton" data-dismiss="modal" id="add">Confirm</button>       
        <script>
	  $('#add').click(function() {
     ...
     var cur1 = $('#west1').val(),
      ...
      alloc1 = $('#south1').val(),
      allo1 = $('#north1').val();
$('#table2 tbody').append('<tr><td>' + cur1 + '</td><td>' + price1 + '</td><td>' + alloc1 + '</td><td>' + allo1 + '</td></tr>');
